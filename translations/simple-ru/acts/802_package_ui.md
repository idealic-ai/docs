...
:term[Схема]{canonical="Schema"} говорит, _что_ показывать, а **Таблица стилей** — _как_ это будет выглядеть. Такое разделение позволяет полностью менять дизайн, не трогая саму структуру данных.
