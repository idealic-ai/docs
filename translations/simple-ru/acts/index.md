...
Эти документы — как подробные инструкции или правила для сборки. В них мы описываем, как именно будем создавать нашу систему. Это главный источник информации о том, как всё работает, и стандарты, которым мы обещаем следовать.
...
Эти документы — мостик между нашей большой мечтой и тем, как мы воплощаем её в жизнь. Они дополняют [Манифест Со-Освобождения](../manifesto/) (ответ на вопрос «Зачем?») и [Эдикт Автономии](../edict/) (ответ на вопрос «Что?»). Прочитав «Акты Становления», ты полностью поймёшь, как устроена наша система и как собрана каждая её деталь.
...
> Sidenote:
> Здесь описываются базовые «кирпичики» для данных и правила общения между разными частями системы.
...
> Sidenote:
> Здесь объясняется, из каких самых простых частей состоят «идеи».
...
> Sidenote:
> В этом разделе речь идёт об основных сервисах и «фундаменте», на котором держится вся система.
...
> Sidenote:
> Это документация к главным библиотекам кода, которые заставляют всю систему работать.
...
Прежде чем вносить свой вклад, пожалуйста, прочтите [Руководство по стилю для Актов](./000_style_guide.md).
