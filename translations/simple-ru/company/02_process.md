...
sequenceDiagram
    ...
    Author->>Proposal: 1. Готовит Предложение
    ...
    loop Цикл обратной связи
        ...
        Alignment->>Author: 4. Проверка
        Author->>Proposal: 5. Исправление Предложения
    end
...
6.  **Обновить :term[Спецификацию]{canonical="Specification"}:** Опираясь на замороженное :term[Предложение]{canonical="Proposal"}, мы обновляем :term[Спецификацию]{href="./20*document_spec.md"} _перед_ тем, как писать код. Это творческий шаг, где «Что» превращается в «Как».
