...
2.  **HTTP GET** на `https://idealic.academy/en/company/00_truth.md/`
...
- [:term[50: Запрос/Истина]{canonical="50: Prompt/Truth"}](https://idealic.academy/en/company/00_truth.md/)
...
- :term[50: Запрос/Истина]{href="https://idealic.academy/en/company/00_truth.md/" canonical="50: Prompt/Truth"} (Стандарты написания: утвердительность, точность, без "воды")
