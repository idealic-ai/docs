...
Эти документы — нормативные спецификации, которые объясняют намерения нашей команды по реализации. Они служат основным источником информации о технических протоколах системы, устанавливая стандарты, которым мы следуем и на основе которых развиваемся.

> Sidenote:
> [Idealic](http://idealic.ai) призван освободить идеи.
>
...
> Sidenote:
> Определяет фундаментальные структуры данных и стандарты коммуникации экосистемы.
>
