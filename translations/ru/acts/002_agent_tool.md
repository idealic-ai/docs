...
> - **`_delegate`**: Делегирует выполнение инструмента изолированному внешнему делегату. См. :term[013: Агент/Делегат]{href="./014_agent_delegate.md"}
...
> - **`_instance`**: Направляет выполнение инструмента на конкретный экземпляр в запросе с несколькими экземплярами. См. :term[012: Агент/Экземплирование]{href="./013_agent_instancing.md"}
