...
Эти документы — это нормативные спецификации, описывающие, что и как мы планируем реализовать. Они служат главным справочником по техническим протоколам системы и устанавливают стандарты, которых мы придерживаемся и на которых строим нашу работу.
...
Этот документ — мост между высокоуровневым видением и практической реализацией. Его дополняют [Манифест Со-Освобождения](../manifesto/) (Зачем) и [Эдикт Автономии](../edict/) (Что). Прочтение этих Актов Становления даст вам полное техническое понимание протоколов системы и того, как устроен каждый компонент.
...
> Sidenote:
> Фокусируется на агентских возможностях и моделях исполнения.
>
...
Прежде чем вносить вклад, пожалуйста, ознакомьтесь с [Руководством по стилю для Актов](./000_STYLE_GUIDE.md), дружественным к LLM.
