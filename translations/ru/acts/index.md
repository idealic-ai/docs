...
Эти документы служат нормативными спецификациями, которые отражают подтверждённые намерения нашей команды по реализации. Они являются авторитетным справочником по техническим протоколам системы, устанавливая стандарты, которые мы обязуемся соблюдать и развивать.
...
> Sidenote:
> Документация по основным библиотекам, на которых работает экосистема.
