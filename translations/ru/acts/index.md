...
Эти документы — нормативные спецификации, описывающие подтверждённые намерения нашей команды по реализации. Они являются авторитетным справочником по техническим протоколам системы и устанавливают стандарты, которым мы обязуемся следовать и развивать.
...
Этот документ — мост между высокоуровневым видением и практической реализацией. Он дополняется [Манифестом Со-Освобождения](../manifesto/) (Почему) и [Эдиктом Автономии](../edict/) (Что). Изучение этих Актов Становления даст полное техническое понимание протоколов системы и того, как устроен каждый компонент.
...
> Sidenote:
> Описывает возможности агентов и модели их исполнения.
...
> Sidenote:
> Документация по основным библиотекам, лежащим в основе экосистемы.

- [800: Пакет/Схимия](./800_package_schemistry.md)
- [801: Пакет/Агент](./801_package_agent.md)
- [802: Пакет/UI](./802_package_ui.md)
- [850: Пакет/Игровой Сервис](./850_package_game_service.md)
- [851: Пакет/Движок Покера](./851_package_poker_engine.md)
- [852: Пакет/UI Покера](./852_package_poker_ui.md)

### Приложения

> Sidenote:
> Документация для пользовательских приложений.
