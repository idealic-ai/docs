...
Эти документы служат нормативными спецификациями, которые определяют подтвержденные намерения нашей команды по реализации. Они являются авторитетным источником информации о технических протоколах системы, устанавливая стандарты, которым мы обязуемся следовать и на которых будем строить дальнейшую работу.
...
Этот документ — мост между высокоуровневым видением и практической реализацией. Он дополняется [Манифестом Со-Освобождения](../manifesto/) (Почему) и [Эдиктом Автономии](../edict/) (Что). Прочтение этих Актов Становления даст полное техническое понимание протоколов системы и того, как устроен каждый компонент.
...
> Sidenote:
> Фокусируется на агентных возможностях и моделях исполнения.
>
