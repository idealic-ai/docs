...
Эти документы являются нормативными спецификациями, которые отражают подтверждённые нашей командой намерения по реализации. Они служат авторитетным справочником по техническим протоколам системы, устанавливая стандарты, которым мы обязуемся следовать и которые будем развивать.
...
> Sidenote:
> Сосредоточено на агентных возможностях и моделях исполнения.
>
...
- [852: Пакет/UI для Покера](./852_package_poker_ui.md)
...
> [!TIP]
> Перед тем как вносить свой вклад, пожалуйста, ознакомьтесь с [Руководством по стилю написания Актов](./000_style_guide.md), оптимизированным для LLM.
