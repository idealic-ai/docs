...
Эти документы — нормативные спецификации, описывающие утверждённые нашей командой планы по реализации. Они служат главным источником информации о технических протоколах системы и устанавливают стандарты, которые мы будем соблюдать и развивать.
...
Этот документ — мост между высокоуровневым видением и конкретной реализацией. Его дополняют [Манифест Со-Освобождения](../manifesto/) (Почему) и [Эдикт Автономии](../edict/) (Что). Прочтение этих Актов Становления даст полное техническое понимание протоколов системы и того, как устроен каждый компонент.
...
> Sidenote:
> Определяет основополагающие структуры данных и стандарты коммуникации экосистемы.
...
Перед тем как внести свой вклад, пожалуйста, ознакомьтесь с [Руководством по стилю для Актов](./000_style_guide.md), дружественным к LLM.
