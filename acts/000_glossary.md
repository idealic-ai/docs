...
- :dfn[Scope]{canonical="Scope" href="./004_agent_call.md"}: The locus of execution for a `Call`.
  - :dfn[Inline Scope]{canonical="Inline Scope" href="./004_agent_call.md"}: The `Call` is processed in the current agent's context.
  - :dfn[Delegate Scope]{canonical="Delegate Scope" href="./004_agent_call.md"}: The `Call` is delegated to an external, isolated delegate.
    > Sidenote:
    >
    > - [004: Agent/Call](./004_agent_call.md)
